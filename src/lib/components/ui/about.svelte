...
<div class="max-w-4xl mx-auto mt-16 print:mt-0">
	...
	<p class="text-base text-left md:text-center text-gray-600 leading-relaxed mt-4">
		...
		learning and teaching new technologies and wide receiver route concepts all the same. I am
		always looking for new challenges and opportunities to grow and develop my skills so that I can
		pass them on to the next generation of leaders.
	</p>
</div>
